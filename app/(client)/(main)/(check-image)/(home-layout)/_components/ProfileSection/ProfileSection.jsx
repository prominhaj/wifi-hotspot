...
const ProfileSection = async () => {
    ...
    return (
        <>
            <div
                className={cn(
                    isActive ? 'h-[17rem]' : 'h-48',
                    'relative p-4 text-white bg-gradient-to-b dark:from-[#252e48] dark:bg-[#4276b5] from-[#0FB981] to-[#78D397] rounded-xl'
                )}
            >
                <div className='flex flex-wrap items-center justify-between gap-2 bello'>
                    <div className='flex items-center space-x-4'>
                        <Link href='/profile'>
                            <Avatar className='w-12 h-12 ring-2 ring-green-600'>
                                <AvatarImage
                    ...
                    <div className='flex flex-wrap items-center justify-between gap-2 mt-4'>
                        <div>
                            ...
                            <div className='flex items-center gap-1 text-3xl font-bold'>
                                ...
                                <span>{packageInfo?.paymentId?.amount} TK</span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className='text-sm font-medium'>
                                Activated at{' '}
                                {moment(convertToUTCPlus6(packageInfo?.createdAt)).format(
                                    'MMM DD YYYY'
                                )}
                            </div>
                        </div>
