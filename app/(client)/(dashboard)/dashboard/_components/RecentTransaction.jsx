...
const RecentTransaction = async () => {
    ...
    return (
        <div className='p-3 mt-4 bg-white shadow dark:bg-black rounded-xl'>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-1">
                        <p className='text-xs text-muted-foreground'>
                            {recentTransaction?.packageId?.price} TK | {recentTransaction?.packageId?.validity} DAYS
                        </p>
                        <div className='text-xs text-muted-foreground'>
                            ({recentTransaction?.createdAt?.toLocaleString()})
                        </div>
                    </div>
                </div>
