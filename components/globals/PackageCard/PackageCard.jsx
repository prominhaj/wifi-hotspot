...
const PackageCard = async ({ wifiPackage }) => {
    ...
    const discountPercentage = ((wifiPackage?.discountPrice - wifiPackage?.price) / wifiPackage?.discountPrice) * 100;
    ...
    return (
        <Card className="w-full">
            ...
            <CardFooter className="p-5 pt-0">
                <BuyButton user={user} amount={wifiPackage?.price} packageId={wifiPackage?.id} />
            </CardFooter>
        </Card>
    )
}
