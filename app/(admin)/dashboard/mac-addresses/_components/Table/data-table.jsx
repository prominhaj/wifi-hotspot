    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, columnId, filterValue) => {
            return (
                ...
                row.original.createdAt?.toString().includes(filterValue) ||
                row.original.userId.name?.toLowerCase().includes(filterValue.toLowerCase()) ||
                row.original.userId.phone?.includes(filterValue) ||
                row.original.hotspotUserId.username?.toLowerCase().includes(filterValue.toLowerCase())
            );
        },
    });
